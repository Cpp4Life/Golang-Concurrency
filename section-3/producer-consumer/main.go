...
// numbers, a message indicating what happened to the order, and a boolean
...
// Close if simply a method of closing the channel when we are done with it (i.e.
...
func pizzeria(pizzaMaker *Producer) {
	...
	for {
		...
		if currentPizza != nil {
			...
			// we want to quit, so send pizzaMake.quit to the quitChan (a chan error)
